...
- **`nespreso_client.py`** – Python client for the API. This is a convenience module that allows users to fetch predictions without dealing with HTTP manually. It provides:
